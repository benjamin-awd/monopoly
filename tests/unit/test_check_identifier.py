...
from monopoly.banks import check_identifier_field
...
def test_check_metadata_identifier_field_exact_match():
    ...
    assert check_identifier_field(field, metadata, identifier)
...
def test_check_identifier_field_partial_string_match():
    field = Mock()
    field.name = "creator"
    field.type = str
...
def test_check_identifier_field_no_match():
    field = Mock()
    field.name = "author"
    field.type = str
    ...
    assert not check_identifier_field(field, metadata, identifier)
